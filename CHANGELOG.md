...
## Fork Changes (YOU-miraito/claude-code-action@beta)
...
- **Updated Base Action**: Uses `YOU-miraito/claude-code-base-action@beta` which includes OAuth credential handling
